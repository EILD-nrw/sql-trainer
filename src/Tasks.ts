export default [
  {
    ...
    schema: 'fahrrad',
    difficulty: '3',
    task: 'Welches Teil (Ausgabe: OTeil, Bezeichnung, Typ) benötigt in der Stückliste (Struktur-Tabelle) die Silberfarbe mit der TNr = 3?  Listen Sie diejenigen Teile auf, die dieses Teil (TNr = 3) direkt oder indirekt in der zweiten Stufe verwenden!',
  ...
  },
  {
    ...
    schema: 'fahrrad',
    difficulty: '3',
    task: 'Gibt es Teile (Ausgabe: Teilenummer, Bezeichnung, Typ, Mindestbestand, Summe der Lagerbestände), deren Bestände in der Lagerbestandstabelle, summiert über alle Lager, den Mindestbestand aus der Tabelle Teile unterschreitet?',
  ...
  },
  {
    ...
    schema: 'fahrrad',
    difficulty: '3',
    task: 'Welche Vertriebsangestellten (Nachname, Vorname) mit einem Gehalt größer dem maximalen Gehalt der Gehaltsklasse 4  (Tabelle geh_klassen) stammen aus Gummersbach und haben schon einmal Angebote geschrieben?',
  ...
  },
  {
    ...
    schema: 'fahrrad',
    difficulty: '3',
    task: 'Welche Angestellten (Nach-, Vorname, Beruf, Gehalt, Gehaltsklasse) verdienen mehr als der Durchschnitt aller Gehälter? Anzeige aufsteigend sortiert nach Berufen und absteigend nach den Gehaltsklassen und den Gehältern.',
  ...
  },
  {
    ...
    schema: 'fahrrad',
    difficulty: '2',
    task: 'Ermitteln Sie alle Orte (keine Duplikate), in denen Kunden oder Angestellte wohnen oder beides!',
  ...
  },
  {
    ...
    schema: 'fahrrad',
    difficulty: '1',
    task: 'Geben Sie den insgesamt aufsummierten Bestand über alle Teile aus dem Lagerbestand aus!',
  ...
  },
  {
    ...
    schema: 'fahrrad',
    difficulty: '1',
    task: 'In wievielen Lägern wird das Fahrrad mit der TNr = 1 gelagert?',
  ...
  },
  {
    ...
    schema: 'fahrrad',
    difficulty: '3',
    task: 'Geben Sie die Lagernummer (LANR) und den durchschnittlichen Bestand derjenigen Lager aus, deren durchschnittlich gelagerter Bestand mindesten 50 Einheiten beträgt!',
  ...
  },
  {
    ...
    schema: 'fahrrad',
    difficulty: '2',
    task: 'Listen Sie bitte Nachname, Vorname, Gehalt und Abteilungsname der Informatiker auf, die in Köln beschäftigt sind! Geben Sie Nachname, Vorname Gehalt und Abteilungsnamen aus!',
  ...
  },
  {
    ...
    schema: 'theater',
    difficulty: '1',
    task: 'Welche Schauspieler (Name, Wohnort) haben mindestes einmal im Faust mitgespielt?',
  ...
  },
  {
    ...
    schema: 'theater',
    difficulty: '1',
    task: 'Welche Schauspieler ( Name, Wohnort) haben in Dramen von Schiller mitgespielt?',
  ...
  },
  {
    ...
    schema: 'fahrrad',
    difficulty: '2',
    task: 'Welche Kunden aus Köln werden von Angestellten aus Gummersbach betreut? Geben Sie die Kun_Nr und den Nachnamen aus!',
  ...
  },
  {
    ...
    schema: 'fahrrad',
    difficulty: '1',
    task: 'Welche Nachnamen in der Angestellten-Tabelle fangen mit W an ? Geben Sie nur den Nachnamen aus!',
  ...
  },
  {
    ...
    schema: 'fahrrad',
    difficulty: '3',
    task: 'Welche Angestellten (Ang_Nr, Nachname, Vorname) haben einen Nachamen der mit W beginnt und kein e enthält?',
  ...
  },
  {
    ...
    schema: 'fahrrad',
    difficulty: '1',
    task: 'Wieviele Elemente hat die Teile-Tabelle?',
  ...
  },
  {
    ...
    schema: 'reisen',
    difficulty: '1',
    task: 'Nennen Sie alle aus Spanien erfassten Städte! Geben Sie den Stadtnamen (Spalte: Stadtname) aus!',
  ...
  },
  {
    ...
    schema: 'reisen',
    difficulty: '1',
    task: 'Nennen Sie Name, Vorname und Adresse aller Kunden,  die ein Hotel gebucht haben, welches über mehr Einzelzimmer als Doppelzimmer verfügt!',
  ...
  },
  {
    ...
    schema: 'reisen',
    difficulty: '2',
    task: 'Nennen Sie alle Hotels und die Städte, in denen sie liegen, für die keine Buchung vorliegt!',
  ...
  },
  {
    ...
    schema: 'reisen',
    difficulty: '2',
    task: 'Nennen Sie alle Städte (alle Attribute) mit dem Land, in dem sie liegen und allen zugehörigen Flüghäfen, in denen ein Hotel existiert mit einer Buchung am Anreiseteg 31.12.2000!',
  ...
  },
  {
    ...
    schema: 'reisen',
    difficulty: '1',
    task: 'Nennen Sie Name, Einzelzimmerpreis und Doppelzimmerpreis aller erfassten Hotels in Berlin!',
  ...
  },
  {
    ...
    schema: 'reisen',
    difficulty: '2',
    task: 'Nennen Sie die Namen der Städte, in denen es ein 5-Sterne-Hotel gibt und in denen eine Buchung vorliegt.\r\nUnterdrücken Sie Duplikate!',
  ...
  },
  {
    ...
    schema: 'theater',
    difficulty: '1',
    task: "Welche Schauspieler (Name, Wohnort) haben bei in Weimar uraufgeführten Dramen an ihrem Wohnort als Figur vom Typ 'Held' mitgespielt?\r\nUnterdrücken Sie Duplikate!",
  ...
  },
  {
    ...
    schema: 'theater',
    difficulty: '2',
    task: 'Welcher Dichter (Name, Wohnort) hat in einem seiner eigenen Stücke mitgespielt?',
  ...
  },
  {
    ...
    schema: 'theater',
    difficulty: '2',
    task: 'Welche Schauspieler (Name, Wohnort) waren bei den Sommerfestspielen in Salzburg 1999 länger als zwei Monate engagiert?',
  ...
  },
  {
    ...
    schema: 'theater',
    difficulty: '2',
    task: 'Welche Schauspieler (Name, Wohnort) haben nie gespielt?',
  ...
  },
  {
    ...
    schema: 'reisen',
    difficulty: '3',
    task: 'Bestimmen Sie alle Hotels in Italien, für die keine Buchung vorliegt und geben Sie Name und Klasse dieser Hotels aus, sortiert nach Name!',
  ...
  },
  {
    ...
    schema: 'theater',
    difficulty: '3',
    task: 'Welche Schauspieler (Name, Wohnort) haben Faust oder Wallenstein gespielt?',
  ...
  },
  {
    ...
    schema: 'theater',
    difficulty: '3',
    task: 'Welche Schauspieler (Name, Wohnort) haben nur die Rollen Faust oder Wallenstein, d.h. keine anderen Rollen gespielt? Unterdrücken Sie Duplicate!',
  ...
  },
  {
    ...
    schema: 'theater',
    difficulty: '3',
    task: 'Welche Schauspieler (Name, Wohnort) haben alle Rollen gespielt?',
  ...
  },
  {
    ...
    schema: 'reisen',
    difficulty: '3',
    task: 'Bestimmen Sie die Namen der Hotels in Paris, bei denen ein Einzelzimmer mindestens 10% weniger kostet als der Durchschnitt aller Hotels in Paris!',
  ...
  },
  {
    ...
    schema: 'theater',
    difficulty: '3',
    task: "Welche Schauspieler (Name, Wohnort) haben alle Narrenrollen ( Typ = 'Narr') am Schillertheater gespielt?",
  ...
  },
  {
    ...
    schema: 'reisen',
    difficulty: '3',
    task: 'Bestimmen Sie für jedes Hotel in Köln, für das eine Reservierung vorliegt, die Zahl der Hottelbetten insgesamt und die Zahl der reservierten Betten!',
  ...
  },
  {
    ...
    schema: 'fahrrad',
    difficulty: '1',
    task: 'Welche Teile haben eine Bezeichnung, die mit dem Buchstaben G anfängt? Geben Sie die Bezeichnung aus!',
  ...
  },
  {
    ...
    schema: 'fahrrad',
    difficulty: '2',
    task: 'Von welchen Teilen sind mehr als 10 Einheiten im Bestand aller Lager? (Tabelle : Lagerbestand). Geben Sie diese Teile mit den Attributen TNR, BEZEICHNUNG und der Summe des Bestandes über alle Lager aus !',
  ...
  },
  {
    ...
    schema: 'fahrrad',
    difficulty: '1',
    task: 'Auf welchen Lagern liegt ein Bestand des Rades mit der TNr = 1? Geben Sie die LANR aus!',
  ...
  },
  {
    ...
    schema: 'fahrrad',
    difficulty: '1',
    task: 'Welche Teile haben, summiert über alle Lager, einen Bestand von mehr als 200 Einheiten ? Geben Sie die TNR aus!',
  ...
  },
  {
    ...
    schema: 'fahrrad',
    difficulty: '2',
    task: 'Gibt es Teile, deren Bestand, summiert über alle Lager, den aus der Tabelle Teile unterschreitet ?',
  ...
  },
  {
    ...
    schema: 'fahrrad',
    difficulty: '3',
    task: "In welchem Lager werden die meisten Artikel (Typ = 'Artikel') gelagert? Geben Sie die LANR aus!",
  ...
  },
  {
    ...
    schema: 'fahrrad',
    difficulty: '1',
    task: 'Geben Sie den durchschnittlichen Bestand je Lager aus ! (LANR und durchschnittlichen Bestand ausgeben)',
  ...
  },
  {
    ...
    schema: 'fahrrad',
    difficulty: '2',
    task: 'Geben Sie die Lagernummer und den durchschnittlichen Bestand derjenigen Lager aus, deren Durchschnittsbestand höher als 1500 Einheiten ist!',
  ...
  },
  {
    ...
    schema: 'fahrrad',
    difficulty: '1',
    task: 'Welche Angestellten  stammen aus Gummersbach und gehören zur Abteilung Vertrieb ? Geben Sie Ang_nr, Vorname und Nachname aus!',
  ...
  },
  {
    ...
    schema: 'fahrrad',
    difficulty: '2',
    task: 'Erzeugen Sie eine nach Gehalt aufsteigend sortierte Liste aller Angestellten mit Nachname, Vorname, Gehalt und der  Gehaltsklasse (Tabellen: geh_klasse, Angestellte)',
  ...
  },
  {
    ...
    schema: 'fahrrad',
    difficulty: '1',
    task: 'Welche Angestellten verdienen zwischen 50000 und 80000 DM im Jahr? Geben Sie Ang_nr, Nachnamen und Vornamen aus!',
  ...
  },
  {
    ...
    schema: 'fahrrad',
    difficulty: '1',
    task: "Welche Kunden (Nachname) in der Tabelle Kunden  stehen alphabetisch hinter dem Kunden mit dem Namen 'Mueller' ? ",
  ...
  },
  {
    ...
    schema: 'fahrrad',
    difficulty: '2',
    task: 'Berechnen Sie das durchschnittliche Gehalt aller Angestellten der gleichen Abteilung! Ausgabe: Abt_nr, abteilungen.name, gehalt',
  ...
  },
  {
    ...
    schema: 'fahrrad',
    difficulty: '2',
    task: 'Welche Angestellten (Ang_nr, Nachname) bearbeiten keine Auftraege? ',
  ...
  },
  {
    ...
    schema: 'fahrrad',
    difficulty: '3',
    task: 'Welche  Angestellten (Ausgabe: Ang_nr, Gehalt) verdienen mehr als der Durchschnitt aller Gehälter?  ',
  ...
  },
  {
    ...
    schema: 'fahrrad',
    difficulty: '3',
    task: 'Welche  Angestellten verdienen mehr als der Durchschnitt aller Gehälter der Angestellten ihrer eigenen Abteilung?',
  ...
  },
  {
    ...
    schema: 'fahrrad',
    difficulty: '3',
    task: 'Ermitteln Sie alle Orte, in denen Kunden wohnen oder Angestellte wohnen oder beide! Unterdrücken Sie Duplikate!',
  ...
  },
  {
    ...
    schema: 'fahrrad',
    difficulty: '3',
    task: "Ermitteln Sie die TNR und die Bezeichnungen  derjenigen Rohstoffe (teile.typ = 'Material'), die nicht zur Produkterzeugung verwendet werden! Geben Sie diese Bezeichnungen in Großbuchstaben aus!",
  ...
  },
  {
    ...
    schema: 'fahrrad',
    difficulty: '1',
    task: 'Welche Informatiker verdienen zwischen 50000 und 80000 Euro im Jahr? Die Spalte Gehalt beinhaltet das Monatsgehalt. Geben Sie die Spalten Ang_nr, Nachname, Vorname, Beruf und Gehalt aus!',
  ...
  },
  {
    ...
    schema: 'fahrrad',
    difficulty: '1',
    task: 'Welche Teile (TNR, Bezeichnung) haben als zweiten Buchstaben ein a?',
  ...
  },
  {
    ...
    schema: 'fussball',
    difficulty: '1',
    task: 'Welche Spieler (Ausgabe: Nachname, Vorname) sind für Polen im Angriff?',
  ...
  },
  {
    ...
    schema: 'fussball',
    difficulty: '1',
    task: 'Wie heißt der Trainer (Ausgabe: Trainername) der australischen Mannschaft?',
  ...
  },
  {
    ...
    schema: 'fussball',
    difficulty: '1',
    task: 'Welche Spieler (Ausgabe: Nachname, Vorname) sind für Costa Rica im Angriff?',
  ...
  },
  {
    ...
    schema: 'fussball',
    difficulty: '1',
    task: 'Welche Spieler (alle Spalten) sind Torhueter?',
  ...
  },
  {
    ...
    schema: 'fussball',
    difficulty: '1',
    task: 'Welche Spieler (alle Spalten) spielen im Mittelfeld?',
  ...
  },
  {
    ...
    schema: 'fussball',
    difficulty: '2',
    task: 'Welche Spieler (Ausgabe: Nachname) haben im ersten Spiel (Eröffnungsspiel, Spiel_id = 1) ein Tor geschossen? Geben Sie jeden Nachnamen nur einmal aus!',
  ...
  },
  {
    ...
    schema: 'fussball',
    difficulty: '2',
    task: "Welcher Trainer (Ausgabe: Nation.TrainerName, Spieler.Vorname, Spieler.Nachname, Nation.Nationname) trainiert den Spieler mit der Spieler_ID '55' und wie heißt dieser Spieler?",
  ...
  },
  {
    ...
    schema: 'fussball',
    difficulty: '3',
    task: 'Wie viele Tore schoss der Spieler "Miroslav Klose"?',
  ...
  },
  {
    ...
    schema: 'fussball',
    difficulty: '3',
    task: 'Welcher Spieler (Ausgabe:  Nachname, Nationname, Anzahl_Tore) hat die meisten Tore geschossen?',
  ...
  },
  {
    ...
    schema: 'fussball',
    difficulty: '1',
    task: 'Welche Nationen waren bei der Fußball-WM 2006 beteiligt? Geben Sie bitte nur die Namen der Nationen aus!',
  ...
  },
  {
    ...
    schema: 'fussball',
    difficulty: '1',
    task: 'Welche Spieler (Nachname, Nationname) haben einen Nachnamen, der mit Z hat anfängt und zu welcher Nation gehören diese Spieler?',
  ...
  },
  {
    ...
    schema: 'fussball',
    difficulty: '1',
    task: 'Wie hoch ist die Summe aller Gehälter der Spieler aus Polen?',
  ...
  },
  {
    ...
    schema: 'fussball',
    difficulty: '1',
    task: 'Aus welchen Spielen (alle Spalten) besteht die Vorrunde?',
  ...
  },
  {
    ...
    schema: 'fussball',
    difficulty: '3',
    task: "An welchen Spielen (Spieltag, Termin)  hat der Spieler 'Klose' ein Tor geschossen?",
  ...
  },
  {
    ...
    schema: 'fussball',
    difficulty: '1',
    task: 'Welche Spiele (alle Spalten) fanden am 3. Spieltag statt?',
  ...
  },
  {
    ...
    schema: 'fussball',
    difficulty: '1',
    task: 'Welche Spiele (alle Spalten) gingen 0:0 aus?',
  ...
  },
  {
    ...
    schema: 'fussball',
    difficulty: '2',
    task: 'An welchen Spielen (alle Spalten) nahm Polen teil?',
  ...
  },
  {
    ...
    schema: 'fussball',
    difficulty: '1',
    task: 'Welche Spiele (alle Spalten) fanden am 10.06.2006 statt?',
  ...
  },
  {
    ...
    schema: 'fussball',
    difficulty: '2',
    task: 'Welche Spiele (alle Spalten) fanden vor dem 19.06.2006 statt?',
  ...
  },
  {
    ...
    schema: 'fussball',
    difficulty: '2',
    task: 'Wie heißt der Torhueter (Vorname, Nachname) von Costa Rica?',
  ...
  },
  {
    ...
    schema: 'fussball',
    difficulty: '1',
    task: 'Welche Spiele (alle Spalten) fanden in Berlin statt?',
  ...
  },
  {
    ...
    schema: 'fussball',
    difficulty: '1',
    task: 'Welche (alle Spalten) Mannschaften gehören zur Gruppe H?',
  ...
  },
  {
    ...
    schema: 'fahrrad',
    difficulty: '1',
    task: 'Bestimmen Sie alle Angestellten (alle Spalten) aus der Abteilung mit Abt_Nr =2, die weniger als 2000 Euro verdienen!',
  ...
  },
  {
    ...
    schema: 'fahrrad',
    difficulty: '2',
    task: 'Welche Bauteile (Spalten: TNR, BEZEICHNUNG) sind im Mountainbike, Rocky Mountain Element Race Typ 1, TNr = 1 enthalten? (Auflösung über eine Stufe)!',
  ...
  },
  {
    ...
    schema: 'fahrrad',
    difficulty: '2',
    task: 'iIn welchen Teilen findet die Nabe Inferno (TNr = 42) Verwendung? (Auflösung über eine Stufe, Ausgabe der Spalten TNR und Bezeichnung.!',
    solutionQuery: 'SELECT t.TNR, T.Bezeichnung \r\nFROM Teile t, Struktur s\r\n WHERE t.TNR = s.OTEIL \r\nAND s.UTeil = 42',
    selectType: '4'
  },
  {
    ...
    schema: 'fahrrad',
    difficulty: '2',
    task: 'Für welche Artikel (Tabelle: Artikel) gibt es keine Unterteile in der Strukturtabelle? Zeigen Sie die Teilenummer, die Bezeichnung sowie Verkaufspreis und Jahresumsatz an.',
  ...
  },
  {
    ...
    schema: 'fussball',
    difficulty: '2',
    task: 'Welche Spiele (alle Spalten) in der Gruppe H fanden schon statt?',
  ...
  },
  {
    ...
    schema: 'fahrrad',
    difficulty: '2',
    task: 'Welche Artikel (Ausgabe : TNR) sind nicht auf Lager?',
  ...
  },
  {
    ...
    schema: 'fahrrad',
    difficulty: '3',
    task: 'Welche Artikel (Ausgabe: TNr) sind auf allen Lagern vorhanden?',
  ...
  },
  {
    ...
    schema: 'fussball',
    difficulty: '2',
    task: 'Welche Spiele (alle Spalten) aus der Gruppe H gingen 2:2 aus?',
  ...
  },
  {
    ...
    schema: 'fussball',
    difficulty: '3',
    task: 'Welche Spiele (alle Spalten) der Gruppe B gingen unentschieden aus?',
  ...
  },
  {
    ...
    schema: 'fussball',
    difficulty: '1',
    task: 'Wieviele Nationen machen bei der Fussballweltmeisterschaft mit?',
  ...
  },
  {
    ...
    schema: 'fussball',
    difficulty: '3',
    task: 'In welchen Stadien (Spiele.AUSFUEHRUNGSORT) hat Deutschland nicht gespielt? Geben Sie die Stadien nur einmal aus!',
  ...
  },
  {
    ...
    schema: 'fussball',
    difficulty: '2',
    task: 'Wieviele Stadien (distinct Spiele.AUSFUEHRUNGSORT) gibt es, an denen Weltmeisterschaftsturniere stattfinden?',
  ...
  },
  {
    ...
    schema: 'fussball',
    difficulty: '2',
    task: 'In welchen Stadien (Ausgabe: spiele.ausfuehrungsort) spielt die Nationalmannschaft von England in der Vorrunde?',
  ...
  },
  {
    ...
    schema: 'fussball',
    difficulty: '3',
    task: 'Welche Spiele hat Ecuador gewonnen? Geben Sie die Spiel_ID, die Mannschaften und das Ergebnis aus. Dabei können Sie davon ausgehen, dass keine zweistelligen Ergebnisse (mehr als 10 Tore für eine Mannschaft) vorliegen!',
  ...
  },
  {
    ...
    schema: 'fussball',
    difficulty: '3',
    task: 'Welche Mannschaft (Ausgabe: Mannschaft, SUM(Tore)) hat in der Vorrunde die meisten Tore geschossen? Geben Sie alle Mannschaften aus, mit der Summe aller Tore und sortieren Sie die Ausgabe absteigend nach der Summe über alle Tore!',
  ...
  },
  {
    ...
    schema: 'fussball',
    difficulty: '3',
    task: 'Welche Mannschaft hat die meisten Tore in der Vorrunde geschossen?',
  ...
  },
  {
    ...
    schema: 'fussball',
    difficulty: '3',
    task: 'Welche Mannschaft (Ausgabe: Mannschaft, SUM(Tore)) hat die meisten Tore in der Vorrunde kassiert?',
  ...
  },
  {
    ...
    schema: 'fussball',
    difficulty: '2',
    task: 'Wie viele Spiele gibt es in der Vorrunde?',
  ...
  },
  {
    ...
    schema: 'fussball',
    difficulty: '3',
    task: 'Welche Mannschaft hat in der Vorrunde die meisten Tore kassiert? Geben Sie alle Mannschaften aus, mit der Summe alle Tore und sortieren Sie die Ausgabe absteigend nach der Summe über alle Tore!',
  ...
  },
  {
    ...
    schema: 'fussball',
    difficulty: '3',
    task: 'Welche Spiele (alle Spalten) gingen unentschieden aus? ',
  ...
  },
  {
    ...
    schema: 'fahrrad',
    difficulty: '3',
    task: 'Ermitteln Sie die Summe über alle Lieferungen je Rohstoff für alle Lieferanten!  ',
  ...
  },
  {
    ...
    schema: 'fahrrad',
    difficulty: '3',
    task: 'Wieviele Angestellte (Ang_nr, Nachname) sind zwischen dem 1.1.1990 und dem 1.1.1997 eingestellt worden?',
  ...
  },
  {
    ...
    schema: 'fahrrad',
    difficulty: '3',
    task: 'In welchen Abteilungen (Abt_nr, Name)  sind alle Berufe vertreten?',
  ...
  },
  {
    ...
    schema: 'fahrrad',
    difficulty: '2',
    task: 'Bestimmen Sie die Angestellten (Nachname, Vorname) aus der Abteilung mit Abt_Nr =2, die mehr als 5000 DM verdienen!',
  ...
  },
  {
    ...
    schema: 'fahrrad',
    difficulty: '1',
    task: 'Bestimmen Sie verschiedenen alle Artikel-Typen!',
  ...
  },
  {
    ...
    schema: 'fahrrad',
    difficulty: '1',
    task: 'Welchen Namen hat die Abteilung mit der Abteilungsnummer Abt_Nr = 2?',
  ...
  },
  {
    ...
    schema: 'fahrrad',
    difficulty: '2',
    task: "Welche Artikel (Typ = 'Artikel') liegen im Hauptlager und haben einen Bestand > 0?  Geben Sie TNr und Bezeichnung aus!",
  ...
  },
  {
    ...
    schema: 'fahrrad',
    difficulty: '2',
    task: 'Welche Materialien werden von Lieferanten aus Dortmund geliefert? Geben Sie TNr und Bezeichnung aus!',
  ...
  },
  {
    ...
    schema: 'fahrrad',
    difficulty: '2',
    task: 'Welche Angestellten haben einen Vornamen, der als zweiten Buchstaben ein u hat?',
  ...
  },
  {
    ...
    schema: 'fahrrad',
    difficulty: '3',
    task: 'Welche Kunden haben Artikel bestellt, die nicht auf Lager sind?',
  ...
  },
  {
    ...
    schema: 'fahrrad',
    difficulty: '2',
    task: 'Listen Sie bitte Nachname, Vorname und Gehalt und Abteilungsname der Informatiker auf, die in Köln beschäftigt sind!',
  ...
  },
  {
    ...
    schema: 'fahrrad',
    difficulty: '1',
    task: 'Finde die Abteilungsnummern von Abteilungen in Dortmund, in denen es Angestellten gibt, die weniger als 2000 verdienen!',
  ...
  },
  {
    ...
    schema: 'fahrrad',
    difficulty: '2',
    task: 'Finde die Ang_nr, Nachnamen und den Vornamen der Angestellten, die den gleichen Beruf und das gleiche Gehalt wie der Angestellte Ilse  Brunn haben!',
  ...
  },
  {
    ...
    schema: 'fahrrad',
    difficulty: '1',
    task: 'Wieviele Frauen arbeiten bei der Fahrradfirma Byce&Co? ',
  ...
  },
  {
    ...
    schema: 'fahrrad',
    difficulty: '1',
    task: 'Geben Sie alle Daten der Tabelle Werke aus!',
  ...
  },
  {
    ...
    schema: 'fahrrad',
    difficulty: '3',
    task: "Welche Teile haben eine Bezeichnung, die mit dem Buchstaben 'g' anfängt oder ein 'a' als zweiten Buchstaben hat? In beiden Fällen darf als letzter Buchstabe kein 't' auftreten. (Groß- und Kleinschreibung spielt bei der Suche keine Rolle.)  Arbeiten Sie mit SELECT * ....",
  ...
  },
  {
    ...
    schema: 'fahrrad',
    difficulty: '2',
    task: 'Geben Sie eine Liste über alle Artikel aus, mit den Attributen TNr, Bezeichnung und Verkaufspreis, wobei die Preise um 10 % erhöht werden ! Sortieren Sie die Liste absteigend nach den Preisen und bei gleichem Preis noch mal alphabetisch aufsteigend nach der Bezeichnung !',
  ...
  },
  {
    ...
    schema: 'fahrrad',
    difficulty: '3',
    task: 'Von welchen Teilen mit einem Einkaufspreis von 100 EUR und mehr sind mehr als 1000 Einheiten im Bestand aller Lager zusammen? (Tabelle : Lagerbestand). Geben Sie diese Teile mit den Attributen TNR, BEZEICHNUNG und der Summe des Bestandes über alle Lager aus!',
  ...
  },
  {
    ...
    schema: 'busse',
    difficulty: '1',
    task: 'Geben Sie die Vor- und Nachnamen (Vorname, Nachname) aller Mitarbeiter aus!',
  ...
  },
  {
    ...
    schema: 'busse',
    difficulty: '1',
    task: 'Geben Sie die Fahrzeug_id des Busses aus, der bei der Firma BOCO zur Inspektion muss!',
  ...
  },
  {
    ...
    schema: 'busse',
    difficulty: '1',
    task: 'Mit welchen Führerscheinklassen (kuerzel, bezeichnung) können Busse mit einer Sitzplatzanzahl von mehr als 10 gefahren werden?',
  ...
  },
  {
    ...
    schema: 'busse',
    difficulty: '1',
    task: 'Welche Mitarbeiter (alle Spalten) wohnen in Köln?',
  ...
  },
  {
    ...
    schema: 'busse',
    difficulty: '1',
    task: 'Geben Sie die Mitarbeiter (Vorname, Nachname) aus, deren Postleitzahl mit 51 anfängt!',
  ...
  },
  {
    ...
    schema: 'busse',
    difficulty: '1',
    task: 'Welche Busse sind bereits abgemeldet?',
  ...
  },
  {
    ...
    schema: 'busse',
    difficulty: '1',
    task: 'Wie hoch ist die Summe aller Gehälter der Nichtbusfahrer?',
  ...
  },
  {
    ...
    schema: 'busse',
    difficulty: '1',
    task: 'Geben Sie die Anzahl der Fahrten nach der Fahrzeug_id gruppiert aus!',
  ...
  },
  {
    ...
    schema: 'busse',
    difficulty: '1',
    task: 'Welche Busse (alle Spalten) besitzen mehr als 45 Sitzplätze?',
  ...
  },
  {
    ...
    schema: 'busse',
    difficulty: '1',
    task: 'Ermitteln Sie den Busfahrer (mita_id) mit dem höchsten Stundenlohn!',
  ...
  },
  {
    ...
    schema: 'busse',
    difficulty: '2',
    task: 'Welche Mitarbeiter (Vorname, Nachname) sind Schaffner?',
  ...
  },
  {
    ...
    schema: 'busse',
    difficulty: '2',
    task: 'Welche Mitarbeiter (Vorname, Nachname, Stundenlohn) sind Busfahrer und haben einen Stundenlohn von mehr 10?',
  ...
  },
  {
    ...
    schema: 'busse',
    difficulty: '2',
    task: 'Welche Busfahrer (MITA_ID, Vorname, Nachname) besitzen KEINEN Führerschein?',
  ...
  },
  {
    ...
    schema: 'busse',
    difficulty: '2',
    task: 'Welche Busse (fahrzeug_id) besitzen mehr Sitzplätze als der Mittelwert aller Busse?',
  ...
  },
  {
    ...
    schema: 'busse',
    difficulty: '2',
    task: 'Welche Busse (fahrzeug_id) wurden im September 2009 angemeldet?',
  ...
  },
  {
    ...
    schema: 'busse',
    difficulty: '2',
    task: 'Geben Sie alle Busfahrer (vorname, nachname) aus, deren Stundenlohn kleiner ist, als das durchschnittliche Gehalt der restlichen Mitarbeiter! Jeder Busfahrer arbeitet 160 Stunden im Monat (40 Stunden pro Woche a 4 Wochen)!',
  ...
  },
  {
    ...
    schema: 'busse',
    difficulty: '2',
    task: 'Geben Sie die Busse (alle Spalten) aus, die noch nie zu einer Inspektion waren!',
  ...
  },
  {
    ...
    schema: 'busse',
    difficulty: '2',
    task: 'Geben Sie das durchschnittliche Gehalt aller Mitarbeiter aus incl. Busfahrer und Nichtbusfahrer! Das Gehalt der Busfahrer kann mit Stundenlohn*160 berechnet werden.',
  ...
  },
  {
    ...
    schema: 'busse',
    difficulty: '2',
    task: 'Geben Sie die größte Entfernung zweier Haltestellen aus!',
  ...
  },
  {
    ...
    schema: 'busse',
    difficulty: '2',
    task: 'Welche Busse (fahrzeug_id) werden auf einer Strecke mit mehr als 3 km eingesetzt (doppelte Datensätze sollen unterdrückt werden!)?',
  ...
  },
  {
    ...
    schema: 'busse',
    difficulty: '3',
    task: 'Welche Busfahrer (MITA_ID, Vorname, Nachname) wurden bisher nicht im Einsatzplan berücksichtigt?',
  ...
  },
  {
    ...
    schema: 'busse',
    difficulty: '3',
    task: "Welche Busfahrer (Vorname, Nachname) fahren die Linien, die nur an Feiertagen (Bemerkung = 'F') fahren? Unterdrücken Sie doppelte Spalten!",
  ...
  },
  {
    ...
    schema: 'busse',
    difficulty: '3',
    task: 'Welche Busfahrer (Vorname, Nachname) besitzen KEINEN Führerschein, wurde aber trotzdem im Einsatzplan eingeteilt?',
  ...
  },
  {
    ...
    schema: 'busse',
    difficulty: '3',
    task: 'Welche Linien (linien_id, bezeichnung) befahren eine Haltestelle, die auf der X-Koordinate "51° 01 N" liegt? Unterdrücken Sie doppelte Datensätze!',
  ...
  },
  {
    ...
    schema: 'busse',
    difficulty: '3',
    task: 'Welche Mitarbeiter (mita_id, vorname, nachname) fahren Busse, die am 01.11.09 zur Inspektion mussten? Beachten Sie, dass keine doppelten Datensätze ausgegeben werden und dass das Feld für den Tag der Inspektion unter Anderem nicht nur das Datum (evtl. Uhrzeit) enthält!',
  ...
  },
  {
    ...
    schema: 'busse',
    difficulty: '3',
    task: 'Geben Sie den Bus aus, der am meisten Fahrten gefahren ist (fahrzeug_id, Anzahl_fahrten)!',
  ...
  },
  {
    ...
    schema: 'busse',
    difficulty: '3',
    task: "Welche Mitarbeiter fahren welche Busse (vorname, nachname, fahrzeug_id), die die Haltestelle 'Seniorenheim' bedienen? Keine doppelten Datensätze ausgeben!",
  ...
  },
  {
    ...
    schema: 'busse',
    difficulty: '3',
    task: 'Welcher Busfahrer (mita_id, vorname, nachname) besitzt alle Führerscheinklassen?',
  ...
  },
  {
    ...
    schema: 'busse',
    difficulty: '3',
    task: 'Welche Busfahrer (mita_id) haben keinen Führerschein und fahren nur auf Linien, die eine Beschränkung "Nur an Schultagen" (Tabelle: beschraenkungen, Spalte: Text)  besitzen? Unterdrücken Sie Duplicate!',
  ...
  },
  {
    ...
    schema: 'busse',
    difficulty: '3',
    task: 'Welche Busse (fahrzeug_id) werden auf Linien eingesetzt, die alle Beschränkungen aufweisen?',
  ...
  },
  {
    ...
    schema: 'fahrrad',
    difficulty: '2',
    task: 'Geben Sie eine Liste aus, über alle Teile mit TNr, Bezeichnung und den Lagern, auf denen die Teile gelagert sind!',
  ...
  },
  {
    ...
    schema: 'fahrrad',
    difficulty: '3',
    task: "Geben Sie eine Liste aus, über alle Teile mit TNr, Bezeichnung und den Lagern, auf denen die Teile gelagert sind  sowie diejenigen Teile, für die kein Lagerbestand vorliegt mit dem Eintrag '0' bei der Lagernummer !",
  ...
  },
  {
    ...
    schema: 'fahrrad',
    difficulty: '1',
    task: 'Zählen Sie alle Abteilungen!',
  ...
  },
  {
    ...
    schema: 'fussball',
    difficulty: '3',
    task: 'Welche Mannschaft hat alle Spiele in der Vorrunde gewonnen?',
  ...
  },
  {
    ...
    schema: 'fussball',
    difficulty: '3',
    task: 'Welche Mannschaft (Nation.Nationnname) wurde Weltmeister 2006?',
  ...
  },
  {
    ...
    schema: 'fussball',
    difficulty: '1',
    task: 'Welche Spieler (Vorname, Nachname) spielen für Paraguay?',
  ...
  },
  {
    ...
    schema: 'fahrrad',
    difficulty: '1',
    task: 'Zählen Sie die Angestellten, die Elektriker sind!',
  ...
  },
  {
    ...
    schema: 'fahrrad',
    difficulty: '1',
    task: 'Zählen Sie die Kunden die in einem Ort mit dem Anfangsbuchstaben G wohnen!',
  ...
  },
  {
    ...
    schema: 'fahrrad',
    difficulty: '3',
    task: 'Geben Sie für jeden Artikel den Namen und den Gesamtumsatz (Verkaufspreis*Anzahl as gesamtumsatz) aus und  sortieren Sie absteigend nach dem Gesamtumsatz!',
  ...
  },
  {
    ...
    schema: 'fahrrad',
    difficulty: '2',
    task: 'Geben Sie die Namen (vorname, nachname) aller Elektriker aus!',
  ...
  },
  {
    ...
    schema: 'fahrrad',
    difficulty: '2',
    task: 'Geben Sie alle Spalten aus der Tabelle Teile aus, die keine Baugruppe sind und deren Bestand höchstens der Mindestbestand ist',
  ...
  },
  {
    ...
    schema: 'theater',
    difficulty: '3',
    task: 'Geben Sie die Namen aller Dichter aus, die in den Monaten Januar oder Februar geboren wurden. ',
  ...
  },
  {
    ...
    schema: 'theater',
    difficulty: '1',
    task: 'Geben Sie alle Stücke (Titel und Autor) aus, die in Weimar uraufgeführt wurden!',
  ...
  },
  {
    ...
    schema: 'theater',
    difficulty: '2',
    task: 'Geben Sie die Anzahl der Dramen an, die in Weimar uraufgeführt und von Schiller geschrieben wurden!',
  ...
  },
  {
    ...
    schema: 'theater',
    difficulty: '2',
    task: 'Welcher Schauspieler (name, figur) stellt welche Figur dar?  Sortieren Sie absteigend nach dem Namen der Figur!',
  ...
  },
  {
    ...
    schema: 'theater',
    difficulty: '2',
    task: 'Geben Sie die Anzahl der Engagements (engaments) und die zugehörigen Namen der Theater aus!',
  ...
  },
  {
    ...
    schema: 'theater',
    difficulty: '3',
    task: 'Geben Sie alle Figuren aus, deren Drama im Mai uraufgeführt wurde. (Ausgabe r.figur, r.titel)\r\n',
  ...
  },
  {
    ...
    schema: 'reisen',
    difficulty: '2',
    task: "Wie hoch ist die durchschnittliche Reisezeit beim Abflug von Köln-Bonn Flughafen an (like 'Köln%')",
  ...
  },
  {
    ...
    schema: 'reisen',
    difficulty: '1',
    task: 'Geben Sie Hotelname, Stadtname, gebuchte Einzelzimmer und gebuchte Doppelzimmer für Hotels an, in denen mehr Einzel- als Doppelzimmer gebucht wurden!',
  ...
  },
  {
    ...
    schema: 'reisen',
    difficulty: '3',
    task: 'Geben Sie die Vor- und Nachnamen der Kunden an, die an einem Sonntag (SUN) ihre Anreise gebucht haben.',
  ...
  },
  {
    ...
    schema: 'reisen',
    difficulty: '2',
    task: 'Geben Sie alle Spalten der Buchungen aus, wo das Abreisedatum an einem Sonntag (SUN) war.',
  ...
  },
  {
    ...
    schema: 'fussball',
    difficulty: '3',
    task: 'Geben Sie den Ausführungsort und die Einnahmen (...as einnahmen) für jedes Spiel an!',
  ...
  },
  {
    ...
    schema: 'fussball',
    difficulty: '2',
    task: 'Geben Sie die Gesamteinnahmen aus allen Spielen an!',
  ...
  },
  {
    ...
    schema: 'fussball',
    difficulty: '3',
    task: 'Geben Sie alle Ausweisnummern aus von Personen, die Spiele der deutschen Mannschaft besucht haben',
  ...
  },
  {
    ...
    schema: 'fussball',
    difficulty: '2',
    task: 'Welche Spieler (Nachname, Vorname, Gehalt_in_euro, ohne Duplikate!) haben in der ersten Halbzeit Tore geschossen?',
  ...
  },
  {
    ...
    schema: 'fussball',
    difficulty: '3',
    task: 'Geben Sie alle Spiele an (Mannschaft_1, Mannschaft_2, Ergebnis) in denen in der Verlängerung (91. - 120. Minute) noch Tore gefallen sind',
  ...
  },
  {
    ...
    schema: 'fussball',
    difficulty: '1',
    task: 'Welche Nationen (alle Spalten) machen bei der Fußballweltmeisterschaft 2006 mit? Ordnen Sie die Ausgabe alphabetisch nach der Spalte "Nationname"!',
  ...
  },
  {
    ...
    schema: 'fussball',
    difficulty: '2',
    task: 'Welcher Trainer (Trainername) trainiert den Spieler "Edison Vicente Mendez"?',
  ...
  },
  {
    ...
    schema: 'fussball',
    difficulty: '2',
    task: 'Welche Nationen haben in der Vorrunde gespielt?',
  ...
  },
  {
    ...
    schema: 'fussball',
    difficulty: '3',
    task: 'Welche Nationen haben nur (!) in der Vorrunde gespielt?',
  ...
  },
  {
    ...
    schema: 'fussball',
    difficulty: '3',
    task: 'Listen Sie die Gruppen auf mit der Anzahl an Toren, die während der Vorrunde geschossen wurden!',
  ...
  },
  {
    ...
    schema: 'fussball',
    difficulty: '1',
    task: 'Wie viele Zuschauer hat für jede Runde des Turniers (Typ des Spiels) gegeben?',
  ...
  },
  {
    ...
    schema: 'fussball',
    difficulty: '2',
    task: 'In welchen Ausführungsorten spielte die Nationalmannschaft von Frankreich in der Vorrunde, die bis zum 22.06.2006 ging?',
  ...
  },
  {
    ...
    schema: 'fussball',
    difficulty: '3',
    task: 'In welchen Ausführungsorten hat Deutschland gewonnen?',
  ...
  },
  {
    ...
    schema: 'fussball',
    difficulty: '1',
    task: 'Welche Trainer (Ausgabe: Trainername) der Mannschaft_1  haben Spiele in der Stadt Dortmund betreut?',
  ...
  },
  {
    ...
    schema: 'fussball',
    difficulty: '2',
    task: 'Welche Trainer (Ausgabe: Trainername, Nationname) der Mannschaft_1 haben nur !!! Spiele in der Stadt Dortmund betreut?',
  ...
  },
  {
    ...
    schema: 'fussball',
    difficulty: '2',
    task: 'In welchen Ausführungsorten wird kein Spiel des Achtelfinals ausgetragen?',
  ...
  },
  {
    ...
    schema: 'fussball',
    difficulty: '1',
    task: 'Welche Mannschaften (Spiele.Mannschaften_1, Spiele.Mannschaften_2) spielten im Finale gegeneinander?',
  ...
  },
  {
    ...
    schema: 'fussball',
    difficulty: '2',
    task: 'Welche Länder spielten in allen Ausführungsorten, die mit H beginnen?',
  ...
  },
  {
    ...
    schema: 'fussball',
    difficulty: '2',
    task: 'Listen Sie alle Spieler des deutschen Teams mit ihrem Trainer auf! (Spalten: NAchname, Vorname, Trainename)',
  ...
  },
  {
    ...
    schema: 'fussball',
    difficulty: '2',
    task: 'Geben Sie alle Spieler der brasilianischen Mannschaft aus, die kein Tor geschossen haben (zu selektierende Spalten: Spieler_id, Nachname)!  ',
  ...
  },
  {
    ...
    schema: 'fussball',
    difficulty: '1',
    task: 'In welchem Spiel (alle Spalten) gewann die deutsche Mannschaft 4:2?',
  ...
  },
  {
    ...
    schema: 'fussball',
    difficulty: '1',
    task: 'Geben Sie alle Spiele vom Typ Vorrunde aus (alle Spalten)!  ',
  ...
  },
  {
    ...
    schema: 'fussball',
    difficulty: '2',
    task: 'Geben Sie alle Spiele aus, welche durch Elfmeterschießen entschieden wurden. (Elfmeter-Tore werden mit der 999 Minute gekennzeichnet!)  (zu selektierende Spalten: spiel_id)',
  ...
  },
  {
    ...
    schema: 'fussball',
    difficulty: '1',
    task: 'Geben Sie alle Spiele aus, die in Berlin ausgetragen wurden (alle Spalten)!',
  ...
  },
  {
    ...
    schema: 'fussball',
    difficulty: '1',
    task: 'Wie viele Euros verdienen alle deutschen Spieler im Jahr insgesamt?  (zu selektierende Spalten: Gehalt_in_Euro)',
  ...
  },
  {
    ...
    schema: 'fussball',
    difficulty: '2',
    task: 'Geben Sie die Spiele (alle Spalten) aus, die in der Zeit vom 24.06.2006 und dem 5.07.2006 ausgetragen wurden!',
  ...
  },
  {
    ...
    schema: 'fussball',
    difficulty: '3',
    task: 'Geben Sie alle Spieler aus, die im Spiel Deutschland gegen Argentinien Tore geschossen haben.  (zu selektierende Spalten: Spieler_ID, Nachname, Nationname)  ',
  ...
  },
  {
    ...
    schema: 'fussball',
    difficulty: '2',
    task: 'Welche Spieler haben in Koeln Tore geschossen? (zu selektierende Spalte: Nachname)  ',
  ...
  },
  {
    ...
    schema: 'fussball',
    difficulty: '2',
    task: 'Welche Mannschaften der Gruppe B schafften es ins Achtelfinale?  (zu selektierende Spalten: Nationname)  ',
  ...
  },
  {
    ...
    schema: 'fussball',
    difficulty: '2',
    task: 'Geben Sie das durchschnittliche Gehalt aller Spieler aus, die weniger als Oliver Kahn verdienen  (zu selektierende Spalten: Gehalt_in_Euro)!  ',
  ...
  },
  {
    ...
    schema: 'fussball',
    difficulty: '1',
    task: 'An welchen Spielen (alle Spalten) nahm England teil?',
  ...
  },
  {
    ...
    schema: 'fussball',
    difficulty: '3',
    task: 'Welche Mannschaft (Ausgabe: Mannschaft) hat kein Tor geschossen?',
  ...
  },
  {
    ...
    schema: 'fahrrad',
    difficulty: '3',
    task: 'Welche  Angestellten (Ausgabe: Ang_nr, Gehalt) verdienen mehr als der Durchschnitt aller Gehälter der Angestellten  jeder einzelnen Abteilung?',
  ...
  },
  {
    ...
    schema: 'fahrrad',
    difficulty: '3',
    task: 'Welche Angestellten verdienen mehr als das durchschnittliche Gehalt irgendeiner Abteilung? Ausgabe: (Ang_nr, Gehalt)',
  ...
  },
  {
    ...
    schema: 'fahrrad',
    difficulty: '3',
    task: 'Geben Sie alle Angestellten (Ang_nr, Gehalt) aus, die mehr als das durchschnittliche Gehalt aller Abteilungen verdienen,wenn man noch mal den Durchschnitt über die durchschnittlichen Gehälter der Einzelabteilungen bildet!\r\n',
  ...
  },
  {
    ...
    schema: 'fussball',
    difficulty: '3',
    task: 'Wie viele Punkte hat Ghana in der Vorrunde bekommen?',
  ...
  },
  {
    ...
    schema: 'fussball',
    difficulty: '2',
    task: 'Welche Mannschaft hat am 13.06.2006 gespielt? Erzeugen Sie eine Tabelleausgabe mit einer Spalte, in der alle Mannschaften aufgeführt sind.',
  ...
  },
  {
    ...
    schema: 'fussball',
    difficulty: '1',
    task: 'Welche Spiele (alle Spalten) fanden in einer Stadt statt (Ausführungsort), die mit K anfängt?',
  ...
  },
  {
    ...
    schema: 'welt',
    difficulty: '1',
    task: 'Wie heißt die Hauptstadt von Ghana?',
  ...
  },
  {
    ...
    schema: 'welt',
    difficulty: '1',
    task: 'Welche Flüsse (Spalte: name) durchqueren einen See? ',
  ...
  },
  {
    ...
    schema: 'welt',
    difficulty: '1',
    task: 'Welche Länder haben eine Fläche (area) zwischen 200000 und 300000 Quadratkilometer? Bitte absteigend über die Fläche ordnen und alle Spalten der Tabelle COUNTRY ausgeben!',
  ...
  },
  {
    ...
    schema: 'welt',
    difficulty: '1',
    task: 'Welche Flüsse münden in ein Meer das mit ‚N‘ anfängt? Geben Sie alle Spalten der Tabelle river aus!',
  ...
  },
  {
    ...
    schema: 'welt',
    difficulty: '1',
    task: 'Welche Städte (city, island) liegen auf einer Insel?',
  ...
  },
  {
    ...
    schema: 'welt',
    difficulty: '1',
    task: 'Welche Städte (city, sea) in Tabelle located liegen an einem Meer?',
  ...
  },
  {
    ...
    schema: 'welt',
    difficulty: '1',
    task: 'Welche Länder (DISTINCT country) haben einen GDP >= 300000?',
  ...
  },
  {
    ...
    schema: 'welt',
    difficulty: '2',
    task: 'Welche Länder grenzen an Deutschland? Sortieren Sie diese Länder aufsteigend nach der Grenzlänge! (country1, country2, length)',
  ...
  },
  {
    ...
    schema: 'welt',
    difficulty: '2',
    task: 'In welchem Land (country, name, population) leben die meisten Menschen?',
  ...
  },
  {
    ...
    schema: 'welt',
    difficulty: '2',
    task: 'Welche Länder (alle Spalten) haben keinen See-Zugang zu einem der Weltmeere?',
  ...
  },
  {
    ...
    schema: 'welt',
    difficulty: '2',
    task: 'Geben Sie die Namen aller Organisationen an (DISTINCT organization, name), in denen Länder mit einem Bruttoinlandsprodukt (BIP) von weniger als 30000 $ pro Person Mitglied sind (das BIP eines Landes ist als “GDP” in der Tabelle “Economy” zu finden)',
  ...
  },
  {
    ...
    schema: 'welt',
    difficulty: '2',
    task: 'Geben Sie alle Flüsse mit ihren Anrainerstaaten (Staaten, die die Flüsse durchqueren) aus.(river, country, name (name von COUNTRY, NICHT RIVER))',
  ...
  },
  {
    ...
    schema: 'welt',
    difficulty: '2',
    task: 'Geben Sie alle Inseln aus mit den zugehörigen Bergen (Tabelle MOUNTAINONISLAND), wobei auch die Inseln, auf denen kein Berg liegt, ausgegeben werden sollen! (island, mountain)',
  ...
  },
  {
    ...
    schema: 'welt',
    difficulty: '2',
    task: 'Geben Sie nur alle Inseln (island) aus, auf denen kein Berg liegt!',
  ...
  },
  {
    ...
    schema: 'welt',
    difficulty: '3',
    task: 'Welcher Staat (country, name, continent, percentage) gehört mehr als einem Kontinent an?',
  ...
  },
  {
    ...
    schema: 'welt',
    difficulty: '3',
    task: 'In welchen Ländern (country, name, language) der Welt werden mehr als zwei  Sprachen gesprochen?',
  ...
  },
  {
    ...
    schema: 'welt',
    difficulty: '3',
    task: 'Berechnen Sie die absoluten Zahlen der Anhänger jeder Religion der Weltbevölkerung sowie den prozentualen Anteil der Anhänger jeder Religion an der Weltbevölkerung (religion, (KALKULATION ABSOLUTE ANZAHL) as amount, (KALKULATION RELATIVE PROZENTZAHL) as percentage)',
  ...
  },
  {
    ...
    schema: 'welt',
    difficulty: '3',
    task: 'Geben Sie die Abkürzungen  aller Organisationen aus, in denen alle Länder mit einem Bruttoinlandsprodukt (BIP, englisch GDP) von mehr als 300000 $ pro Person Mitglied sind (diese Operation wird als relationale Division bezeichnet). (COUNT AS amount, Organization.abbreviation, Organization.name)',
  ...
  },
  {
    ...
    schema: 'welt',
    difficulty: '3',
    task: 'Welcher Fluss hat die meisten Anrainerstaaten? (COUNT (COUNTRY), RIVER)',
  ...
  },
  {
    ...
    schema: 'welt',
    difficulty: '1',
    task: 'Geben Sie alle Kontinente (alle Spalten) aufsteigend nach ihrer Fläche sortiert aus (kleinster Kontinent zuerst)!',
  ...
  },
  {
    ...
    schema: 'welt',
    difficulty: '1',
    task: 'Welche Länder liegen in Europa? Geben Sie die Länderkürzel aus! (Tabelle encompasses)',
  ...
  },
  {
    ...
    schema: 'welt',
    difficulty: '1',
    task: 'Geben Sie alle Wüsten (desert, area) absteigend sortiert (beginnend mit der größten) aus!',
  ...
  },
  {
    ...
    schema: 'welt',
    difficulty: '2',
    task: 'Geben Sie alle Hauptstädte (capital) Europas aus!',
  ...
  },
  {
    ...
    schema: 'welt',
    difficulty: '2',
    task: 'Geben Sie die Insel (island) mit der größten Fläche aus!',
  ...
  },
  {
    ...
    schema: 'welt',
    difficulty: '2',
    task: 'Welcher See (lake) ist der tiefste?',
  ...
  },
  {
    ...
    schema: 'welt',
    difficulty: '3',
    task: 'Welche Sprache (language) wird in den meisten Ländern gesprochen?',
  ...
  },
  {
    ...
    schema: 'welt',
    difficulty: '3',
    task: 'In welchen Ländern (country) gibt es die meisten unterschiedlichen Religion?',
  ...
  },
  {
    ...
    schema: 'welt',
    difficulty: '3',
    task: 'Geben Sie alle Länder mit ihren Provinzen (country, province) aus, die mehr als 50 Provinzen haben!',
  ...
  },
  {
    ...
    schema: 'welt',
    difficulty: '3',
    task: 'Geben Sie alle Länder (country, population_growth, independence) aus, deren Bevölkerung schrumpft und die unabhängig sind (Spalte independence in politics)!',
  ...
  },
  {
    ...
    schema: 'fahrrad',
    difficulty: '2',
    task: 'Wie ist die maximale Stücklistentiefe des Artikel 60?',
  ...
  },
  {
    ...
    schema: 'fahrrad',
    difficulty: '2',
    task: 'Welche Teile sind im Artikel 60 insgesamt enthalten?\r\nGeben Sie aus der Tabelle Struktur OTeil und Uteil aus!',
  ...
  },
  {
    ...
    schema: 'fahrrad',
    difficulty: '3',
    task: 'In welchen Teilen wird das Material mit der TNR 3 verwendet? Geben Sie OTeil, UTeil  unddas Level aus!',
  ...
  },
  {
    ...
    schema: 'welt',
    difficulty: '1',
    task: 'Welche Sprachen (Language) werden in der Schweiz gesprochen?',
  ...
  },
  {
    ...
    schema: 'welt',
    difficulty: '2',
    task: 'Bestimmen Sie alle Länder (Spalten Country, Name), in denen eine Sprache gesprochen wird, die auch in der Schweiz gesprochen wird! Unterdrücken Sie Duplicate!',
  ...
  },
  {
    ...
    schema: 'welt',
    difficulty: '3',
    task: 'Bestimmen Sie alle Länder mit ihren Sprachen (Spalten Country, Name, Language), in denen eine Sprache gesprochen wird, die nicht in der Schweiz gesprochen wird!',
  ...
  },
  {
    ...
    schema: 'welt',
    difficulty: '3',
    task: 'Bestimmen Sie alle Länder (Spalten Country, Name, Language), in denen nur eine Sprache gesprochen wird, die auch in der Schweiz gesprochen wird,  (also keine andere Sprache, als die Sprachen aus der Schweiz)!',
  ...
  },
  {
    ...
    schema: 'welt',
    difficulty: '3',
    task: 'Bestimmen Sie alle Länder (country), in denen alle Sprachen gesprochen werden, die auch in der Schweiz gesprochen werden!',
  ...
  },
  {
    ...
    schema: 'welt',
    difficulty: '3',
    task: 'Bestimmen Sie alle Abkürzungen (Abbreviation) und Namen der Organisationen, die auf jedem Kontinent mindestens ein Mitgliedsland haben! Unterdrücken Sie Duplicate!',
  ...
  },
  {
    ...
    schema: 'welt',
    difficulty: '2',
    task: 'Welche Länder haben einen geringeren Anteil ihrer Fläche in Asien als die Türkei (country in tabelle encombasses)? Unterdrücken Sie doppelte Werte!',
  ...
  },
  {
    ...
    schema: 'welt',
    difficulty: '3',
    task: 'Welche Länder sind in allen Organisationen Mitglied, in denen auch Deutschland ist (Tabelle isMember und Spalte Country)?\r\nUnterdrücken Sie Duplicate!',
  ...
  },
  {
    ...
    schema: 'welt',
    difficulty: '3',
    task: 'Geben Sie alle Länder Europas (Spalten: country, Name, abbreviation, continent) mit ihren Organisationen aus, auch diejenigen Länder, die in keiner Organisation sind!',
  ...
  },
  {
    ...
    schema: 'fussball',
    difficulty: '2',
    task: 'Listen Sie alle Spieler des deutschen Teams mit ihrem Trainer auf! (Spalten: Nachname, Vorname, Trainername)',
  ...
  },
  {
    ...
    schema: 'reisen',
    difficulty: '3',
    task: 'Bestimmen Sie die Namen aller Hotels in Paris, bei denen ein Einzelzimmer mindestens 10% weniger kostet als der Durchschnitt aller Hotels in Paris!',
  ...
  },
  {
    ...
    schema: 'fussball',
    difficulty: '3',
    task: 'Welche Spieler (Ausgabe: Nationname, Nachname, Anzahl_Tore) haben Tore geschossen? Geben Sie die Spieler sortiert über Nationname und Nachnamen aus.',
  ...
  },
  {
    ...
    schema: 'fussball',
    difficulty: '1',
    task: 'Welche Spieler (Nachname, Nationname) haben einen Nachnamen, der mit Z anfängt und zu welcher Nation gehören diese Spieler?',
    solutionQuery: "SELECT Nachname, NationName FROM Spieler WHERE Nachname LIKE 'Z%'",
    selectType: '13'
  },
  {
    ...
    schema: 'fussball',
    difficulty: '1',
    task: 'Wie viele Nationen machen bei der Fußballweltmeisterschaft mit?',
    solutionQuery: 'SELECT count(*) FROM Nation',
    selectType: '12'
  },
  {
    ...
    schema: 'fussball',
    difficulty: '3',
    task: 'In welchen Stadien (Spiele.Ausfuehrungsort) hat Deutschland nicht gespielt? Unterdrücken Sie Duplicate!',
  ...
  },
  {
    ...
    schema: 'fussball',
    difficulty: '2',
    task: 'Wie viele Stadien (Spiele.Ausfuehrungsort) gibt es, an denen Weltmeisterschaftsturniere stattfinden?',
    solutionQuery: 'SELECT COUNT  (distinct spiele.AUSFUEHRUNGSORT) FROM  spiele',
    selectType: '12'
  },
  {
  ...
  },
  {
    ...
    schema: 'welt',
    difficulty: '2',
    task: 'Geben Sie die größte Stadt Finnland aus (Spalten: city, population)!',
  ...
  },
  {
    ...
    schema: 'welt',
    difficulty: '3',
    task: 'Geben Sie die drei größten Städte Finnlands aus! (Spalten: city, population in Tabelle City)',
  ...
  },
  {
    ...
    schema: 'welt',
    difficulty: '1',
    task: 'Geben Sie alle Städte (Spalte city) aus, die in Finnland liegen!',
  ...
  },
  {
    ...
    schema: 'welt',
    difficulty: '2',
    task: 'Welche Seen liegen in Bayern (Spalte lake in der Tabelle lake)',
  ...
  },
  {
    ...
    schema: 'welt',
    difficulty: '3',
    task: 'Bestimmen Sie alle Länder (Spalten Country, Name), in denen nur Sprachen gesprochen werden, die in der Schweiz nicht gesprochen werden! Unterdrücken Sie Duplicate!',
  ...
  },
  {
    ...
    schema: 'welt',
    difficulty: '1',
    task: 'Welche Städte (City, longitude, latitude) liegen zwischen dem 40. und dem 50. Breitengrad (latitude)?',
  ...
  },
  {
    ...
    schema: 'welt',
    difficulty: '1',
    task: 'Welche Hauptstädte sind zugleich Sitz von Organisationen?',
  ...
  },
  {
    ...
    schema: 'welt',
    difficulty: '2',
    task: 'Welche Länder (Spalten: Country, namen) liegen in Europa und in Asien?',
  ...
  },
  {
    ...
    schema: 'welt',
    difficulty: '1',
    task: 'Welche Länder (Spalte COUNTRY in Tabelle ismember und Tabelle  COUNTRY) sind in keiner Organisation?',
